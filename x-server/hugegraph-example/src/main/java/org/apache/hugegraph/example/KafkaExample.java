...
/*
        SyncMutationServer server = new SyncMutationServer(MetaManager.instance()
        .getKafkaSlaveServerPort());
...
/*
        ...
        String val = "{ \"key\": \"hello\", \"value\": \"world, this is raw binary test with lz4
        compress with non-topic\"}";
