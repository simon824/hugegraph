...
public class GraphOfTheMoviesExample {
    ...
    public static void load(final HugeGraph graph) {
        ...
        Vertex theMatrix =
                graph.addVertex(T.label, "movie", "title", "The Matrix", "released", 1999);
        Vertex keanu = graph.addVertex(T.label, "person", "name", "keanu Reeves", "born", 1964);
        Vertex carrie =
                graph.addVertex(T.label, "person", "name", "carrie-anne Moss", "born", 1967);
        Vertex laurence =
                graph.addVertex(T.label, "person", "name", "laurence Fishburne", "born", 1961);
        ...
        Vertex theMatrixRevolutions =
                graph.addVertex(T.label, "movie", "title", "The Matrix Revolutions", "released",
                                2003);
        ...
        Vertex theDevilsadvocate =
                graph.addVertex(T.label, "movie", "title", "The Devil's advocate", "released",
                                1997);

        Vertex charlize =
                graph.addVertex(T.label, "person", "name", "charlize Theron", "born", 1975);
        ...
        Vertex aFewGoodMen =
                graph.addVertex(T.label, "movie", "title", "a Few Good Men", "released", 1992);
        ...
        Vertex kieferS =
                graph.addVertex(T.label, "person", "name", "Kiefer Sutherland", "born", 1966);
        ...
        Vertex christopherG =
                graph.addVertex(T.label, "person", "name", "Christopher Guest", "born", 1948);
        ...
        Vertex anthonyE =
                graph.addVertex(T.label, "person", "name", "anthony Edwards", "born", 1962);
        ...
        Vertex jerryMaguire =
                graph.addVertex(T.label, "movie", "title", "Jerry Maguire", "released", 2000);
        ...
        Vertex jonathanL =
                graph.addVertex(T.label, "person", "name", "Jonathan Lipnicki", "born", 1996);
        ...
        Vertex standByMe =
                graph.addVertex(T.label, "movie", "title", "Stand By Me", "released", 1986);
        ...
        Vertex marshallB =
                graph.addVertex(T.label, "person", "name", "Marshall Bell", "born", 1942);
        ...
        Vertex whatDreamsMayCome =
                graph.addVertex(T.label, "movie", "title", "What Dreams May Come", "released",
                                1998);

        Vertex annabellaS =
                graph.addVertex(T.label, "person", "name", "annabella Sciorra", "born", 1960);
        ...
        Vertex snowFallingonCedars =
                graph.addVertex(T.label, "movie", "title", "Snow Falling on Cedars", "released",
                                1999);
        ...
        Vertex youveGotMail =
                graph.addVertex(T.label, "movie", "title", "You've Got Mail", "released", 1998);
        ...
        Vertex sleeplessInSeattle =
                graph.addVertex(T.label, "movie", "title", "Sleepless in Seattle", "released",
                                1993);
        ...
        Vertex joeVersustheVolcano =
                graph.addVertex(T.label, "movie", "title", "Joe Versus the Volcano", "released",
                                1990);

        Vertex johnS =
                graph.addVertex(T.label, "person", "name", "John Patrick Stanley", "born", 1950);
        ...
        Vertex whenHarryMetSally =
                graph.addVertex(T.label, "movie", "title", "When Harry Met Sally", "released",
                                1998);
        ...
        Vertex rescueDawn =
                graph.addVertex(T.label, "movie", "title", "rescueDawn", "released", 2006);

        Vertex christianB =
                graph.addVertex(T.label, "person", "name", "Christian Bale", "born", 1974);
        ...
        Vertex theBirdcage =
                graph.addVertex(T.label, "movie", "title", "The Birdcage", "released", 1996);
        ...
        Vertex unforgiven =
                graph.addVertex(T.label, "movie", "title", "unforgiven", "released", 1992);

        Vertex richardH =
                graph.addVertex(T.label, "person", "name", "Richard Harris", "born", 1930);
        ...
        Vertex johnnyMnemonic =
                graph.addVertex(T.label, "movie", "title", "Johnny Mnemonic", "released", 1995);
        ...
        Vertex cloudatlas =
                graph.addVertex(T.label, "movie", "title", "Cloud atlas", "released", 2012);
        ...
        Vertex davidMitchell =
                graph.addVertex(T.label, "person", "name", "David Mitchell", "born", 1969);
        Vertex stefanarndt =
                graph.addVertex(T.label, "person", "name", "Stefan arndt", "born", 1961);
        ...
        Vertex natalieP =
                graph.addVertex(T.label, "person", "name", "Natalie Portman", "born", 1981);
        ...
        Vertex speedRacer =
                graph.addVertex(T.label, "movie", "title", "Speed Racer", "released", 2008);
        ...
        Vertex christinaR =
                graph.addVertex(T.label, "person", "name", "Christina Ricci", "born", 1980);
        ...
        Vertex ninjaassassin =
                graph.addVertex(T.label, "movie", "title", "Speed Racer", "released", 2009);
        ...
        Vertex theGreenMile =
                graph.addVertex(T.label, "movie", "title", "The Green Mile", "released", 1999);

        Vertex michaelD =
                graph.addVertex(T.label, "person", "name", "Michael Clarke Duncan", "born", 1957);
        ...
        Vertex patriciaC =
                graph.addVertex(T.label, "person", "name", "Patricia Clarkson", "born", 1959);
        ...
        Vertex frostNixon =
                graph.addVertex(T.label, "movie", "title", "Frost/Nixon", "released", 2008);
        ...
        Vertex philipH =
                graph.addVertex(T.label, "person", "name", "Philip Seymour Hoffman", "born", 1967);
        ...
        Vertex robertZ =
                graph.addVertex(T.label, "person", "name", "Robert Zemeckis", "born", 1951);
        ...
        Vertex oneFlewOvertheCuckoosNest =
                graph.addVertex(T.label, "movie", "title", "One Flew Over the Cuckoo's Nest",
                                "released", 1975);
        ...
        Vertex somethingsGottaGive =
                graph.addVertex(T.label, "movie", "title", "Something's Gotta Give", "released",
                                2003);
        ...
        Vertex charlieWilsonsWar =
                graph.addVertex(T.label, "movie", "title", "Charlie Wilson's War", "released",
                                2007);
        ...
        Vertex aLeagueofTheirOwn =
                graph.addVertex(T.label, "movie", "title", "a League of Their Own", "released",
                                1992);
