...
public final class ApiVersion {
     ...
     * [0.4] HugeGraph-162: Add schema builder to seperate client and inner interface.
     ...
     * version 0.13:
     * [0.67] Issue-11: hugegraph with etcd/pd, add graphspace, remove auth server
    ...
    public static void check() {
        // Check version of hugegraph-core. It's a little trick here
        VersionUtil.check(CoreVersion.VERSION, "1.0", "3.8", CoreVersion.NAME);
    }
}
