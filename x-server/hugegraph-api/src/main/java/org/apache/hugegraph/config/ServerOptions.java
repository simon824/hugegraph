...
public class ServerOptions extends OptionHolder {
    ...
    public static final ConfigOption<Integer> METRICS_DATA_TTL =
            new ConfigOption<>(
                    "metrics.data_ttl",
                    "The survival time (min) of metrics data in pd (Default =" +
                    " 120min = 2hour)",
                    rangeInt(1, Integer.MAX_VALUE),
                    120
            );
    public static final ConfigOption<Integer> METRICS_DATA_REPORT_TIME =
            new ConfigOption<>(
                    "metrics.data_report_time",
                    "Cycle time of metrics data reporting pd (DEFAULT = 60s)",
                    rangeInt(1, Integer.MAX_VALUE),
                    60
            );
    ...
    public static final ConfigOption<String> VERMEER_SERVER_URL =
            new ConfigOption<>(
                    "vermeer.server_url",
                    "The url of vermeer server.",
                    disallowEmpty(),
                    "http://127.0.0.1:8688"
            );
    public static final ConfigOption<Integer> VERMEER_SERVER_REQUEST_TIMEOUT =
            new ConfigOption<>(
                    "vermeerserver.request_timeout",
                    "The timeout in seconds of waiting for vermeer server.",
                    positiveInt(),
                    1000
            );
    ...
    public static final ConfigOption<String> PERSONAL_RANK_FILE_PATH =
            new ConfigOption<>(
                    "personal_rank.file_path",
                    "personal rank file path",
                    disallowEmpty(),
                    "/ssd1/baidu_hg"
            );
    public static final ConfigOption<String> PERSONAL_RANK_FILE_SUFFIX =
            new ConfigOption<>(
                    "personal_rank.suffix",
                    "personal rank file suffix",
                    disallowEmpty(),
                    "txt"
            );
