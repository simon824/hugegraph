...
public class IdHolderList extends ArrayList<IdHolder> implements AutoCloseable {
    ...
    public void close() throws Exception {
        this.forEach(idHolder -> {
            if (idHolder instanceof AutoCloseable) {
                try {
                    ((AutoCloseable) idHolder).close();
                } catch (Exception e) {
