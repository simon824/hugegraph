...
public abstract class AbstractTransaction implements Transaction {
    ...
    protected static final Logger QUERYLOGGER =
            Log.logger("org.apache.hugegraph.querylogger");
    ...
    protected QueryResults<BackendEntry> query(Query query) {
        ...
        if (query.empty() && !query.getClass().equals(Query.class)) {
            QUERYLOGGER.warn("Query without any id or condition, current: {}, " +
                             "origin:{}", query, query.originQuery());
        }
