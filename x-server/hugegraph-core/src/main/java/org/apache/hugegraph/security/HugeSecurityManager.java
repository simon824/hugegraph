...
public class HugeSecurityManager extends SecurityManager {
    ...
    private static final Set<String> HSTORE_CLASSES = ImmutableSet.of(
            "org.apache.hugegraph.backend.store.hstore.HstoreStore",
            "org.apache.hugegraph.backend.store.hstore.HstoreTable",
            "org.apache.hugegraph.backend.store.hstore.HstoreSessionsImpl",
            "org.apache.hugegraph.backend.store.hstore.HstoreTables",
            "org.apache.hugegraph.backend.store.hstore.HstoreProvider"
    );

    private static final Set<String> ETCD_CLASSES = ImmutableSet.of(
            "org.apache.hugegraph.meta.EtcdMetaDriver",
            "org.apache.hugegraph.meta.MetaManager"
    );

    private static final Set<String> RATELIMITER_CLASSES = ImmutableSet.of(
            "org.apache.hugegraph.util.RateLimiter"
    );
