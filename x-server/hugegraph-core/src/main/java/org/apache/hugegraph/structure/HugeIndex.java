...
public class HugeIndex implements GraphType, Cloneable {
    ...
    /*
     * HugeIndex read use elementIds, HugeIndex write always one element, use
     * elementId
     */
    ...
    public HugeIndex(HugeGraph graph, IndexLabel indexLabel, boolean write) {
        E.checkNotNull(graph, "graph");
        E.checkNotNull(indexLabel, "label");
        E.checkNotNull(indexLabel.id(), "label id");
        this.graph = graph;
    ...
    public static Id formatIndexId(HugeType type, Id indexLabelId,
        ...
        if (type.isStringIndex()) {
            ...
            // 1 为表类型 4 为lableId length为value
