...
public class GremlinJob extends UserJob<Object> {
    ...
    public String taskType = "gremlin";
    public String taskBindName = "gremlinJob";

    public GremlinJob(String taskType, String taskBindName) {
        this.taskType = taskType;
        this.taskBindName = taskBindName;
    }
    ...
    public Object execute() throws Exception {
        ...
        bindings.put(taskBindName, new GremlinJobProxy());
