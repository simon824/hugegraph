...
public class HugeException extends RuntimeException {
    ...
    public HugeException(ErrorCode code, String message) {
    ...
    public HugeException(ErrorCode code, String message, Throwable cause) {
    ...
    public HugeException(ErrorCode code, Throwable cause, Object... args) {
