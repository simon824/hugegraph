...
public class EdgeLabelBuilder extends AbstractBuilder
    ...
    public EdgeLabel build() {
        ...
        // 待子edgeLabel 填充完,再向父edgelabel注册
    ...
    @Override
    public EdgeLabel.Builder asGeneral() {
        this.edgeLabelType = EdgeLabelType.GENERAL;
        return this;
    }
    ...
    private void checkRelation() {
        ...
        if (this.edgeLabelType.parent()) {
            ...
            E.checkArgument(this.links.isEmpty(),
                            "The links of the general edge label must be empty");
        } else {
            E.checkArgument(!this.links.isEmpty(),
    ...
    private String mapElId2Name(HugeGraph graph, Id fatherId) {
