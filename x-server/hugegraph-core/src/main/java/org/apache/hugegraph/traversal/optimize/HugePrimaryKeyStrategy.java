...
/**
 * @author lynn.bond@hotmail.com on 2023/2/27
 */
public class HugePrimaryKeyStrategy
    ...
    private static final Logger LOG = Log.logger(HugePrimaryKeyStrategy.class);
    ...
    public static HugePrimaryKeyStrategy instance() {
        LOG.info("HugePrimaryKeyStrategy loaded.");
        return INSTANCE;
    }
